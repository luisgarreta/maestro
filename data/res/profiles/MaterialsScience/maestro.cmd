...
# Freeze unselected atoms during cleanup
prefer geometrycleanupfreezeatoms=true
# Materials Science has All as default for interaction modes
displayhbondsmode mode=all
displaycontactsmode mode=all
displaypiinteractionsmode mode=all
prefer  interactionsvisible=false
